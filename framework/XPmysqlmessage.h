#ifndef _XPMYSQLMSG_HEADER_H_
#define _XPMYSQLMSG_HEADER_H_
...
#endif /* _XPMYSQLMSG_HEADER_H_ */

typedef SINGLETON<MSGMYSQL> messagecon; // link -> Message
