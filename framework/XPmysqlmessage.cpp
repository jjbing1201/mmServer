...
int  MSGMYSQL::mysql_start_transaction()
{
...
void MSGMYSQL::mysql_stop_transaction()
{
...
int MSGMYSQL::_get_execute_result(std::string &statements, char* resultbuf)
{
    /* initialize variable. */
...
int MSGMYSQL::_transaction_operation(std::string &statements)
{
...
std::map<std::string, std::string> MSGMYSQL::dbconnectInfo(std::string & info)
{
...
*/
bool MSGMYSQL::create_connect(const std::string & ipaddress, int port, const std::string & username, const std::string & password, const std::string & dbname)
{
...
*/
int MSGMYSQL::table_max_line(std::string & tablename)
{
...
int MSGMYSQL::search_table_engines(std::string &tablename)
{
    /* combine select sqlcmd. */
...
*/
int MSGMYSQL::mysql_execute(std::string & statements)
{
...
*/
char * MSGMYSQL::get_execute_result(std::string & statements)
{
    /* clean result. */
    cleaning_result();
...
char * MSGMYSQL::get_execute_result(std::string & statements, std::string &charset)
{
    /* clean result. */
    cleaning_result();
...
int MSGMYSQL::transaction_to_start(void)
{
...
int MSGMYSQL::transaction_op_result(std::string &tablename, \
...
void MSGMYSQL::transaction_finish(int op)
{
    if (op == 1)
